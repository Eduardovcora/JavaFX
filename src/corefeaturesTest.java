...
class CoreFeaturesTest {
    ...
    void testEditTransaction() {
        ...
        assertTrue(edited, "Transaction edit failed.");
    ...
    void testDeleteTransaction() {
        ...
        assertTrue(deleted, "Transaction deletion failed.");
    ...
    void testGetSummary() {
        ...
        assertTrue(summary.contains("Total Income: $1000.00"), "Summary does not show correct income.");
        assertTrue(summary.contains("Total Expenses: $350.00"), "Summary does not show correct expenses.");
        assertTrue(summary.contains("Net income: $650.00"), "Summary does not show correct net income.");
    }
    ...
    void testEquals() {
        ...
        assertTrue(core.equals(core), "equals() method failed.");
    }
